...
import { fetchViewFunctionByAddress } from "../utils/getFunction";
...
function MyDonations() {
  ...
  const viewFuncByAddress = async() => {
    ...
    try {
      ...
      const response = await fetchViewFunctionByAddress(walletAddress);
    ...
    <>
      <div className="min-h-screen bg-gradient-to-r from-purple-300 via-pink-300 to-yellow-300">
        ...
        <div className="w-full mt-8">
          <div className="">
            <h2 className="text-xl font-semibold text-gray-800 text-center">My Donations</h2>
          </div>
