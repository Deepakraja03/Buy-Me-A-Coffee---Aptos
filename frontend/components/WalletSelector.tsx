  ...
  return connected ? (
    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      <DialogTrigger asChild>
        <Button className="px-6 py-3 rounded-full bg-purple-600 text-white font-semibold shadow-lg hover:bg-purple-700 hover:shadow-xl transition duration-300">Connect a Wallet</Button>
      </DialogTrigger>
